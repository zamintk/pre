...
<body>
    <header class=" p-5">
        ...
        <nav class="container d-flex justify-content-between align-items-center" >
            <img src="img/tim-maia323.png" class="nav-img " loading="lazy">
            <ul class="nav mt-5">
        ...
        <section id="inicio" class="my-5">
            <div class="inicio-fundo d-flex justify-content-between align-items-center">
                <div class="">
                    ...
                    <img src="img/" class="mb-3" width="563"
                    <img src="img/" class="mb-3" width="563"
                    <img src="img/tim-maia535.jpeg" class="mb-3" width="563"
                    height="278" loading="lazy">
                    <a href="#tim-maia"
                        class="btn btn-primary btn-lg botao-inicio fw-semibold">Quero
                        conhecer!</a>
                </div>
                <img src="img/tim.maia1.jpg" alt="A imagem apresenta o cantor Tim Maia" title="Os mutantes - CC0 Domínio Público / Acervo Arquivo Nacional" class="img-fluid img-inicio">

              </div>
        </section>
        <section id="tim-maia" class="my-5 pt-6 secao-tim.maia" tabindex="0" aria-label="Seção explicativa sobre o Tim Maia">
        <section id="tim-maia" class="my-5 pt-6 secao-tim-maia" tabindex="0" aria-label="Seção explicativa sobre o Tim Maia">
            <div class="container d-flex align-items-center ">
                <div class="col-4 d-flex justify-content-center ">
                    <img src="img/tim.maia6.jpeg" class="rounded-pill" width="273" height="331" loading="lazy">
                </div>
                <div class="col-5">
                    <h2>Quem foi Tim Maia?</h2>
                    <p class="p-2">Tim Maia foi um cantor e compositor brasileiro,
                     famoso por sua voz marcante e por misturar soul, funk e MPB. Nascido em 1948 no Rio de Janeiro, ele se destacou nos anos 
                     70 com sucessos como "Me Dê Motivos" e "Gostava Tanto de Você". Conhecido também por sua personalidade excêntrica e comportamento polêmico, Tim Maia se tornou um ícone da música brasileira.
                     Faleceu em 1998, mas sua obra continua a influenciar a música nacional.</p>
                </div>
            </div>
        </section>
        ...
        <section id="galeria" tabindex="0" aria-label="Seção de galeria de imagens">
            ...
            <div class="container p-3 mt-3 fundo-galeria ">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-4">
                        <img src="img/tim.maia2.jpg"
                            class="img-fluid rounded-5" loading="lazy">
                    </div>
                    <div class="col-md-4">
                        <img src="img/tim.maia3.jpeg" class="img-fluid rounded-5"
                            loading="lazy">
                    </div>
                </div>
                <div class="row mt-4  justify-content-md-center">
                    <div class="col-md-4">
                        <img src="img/tim.maia4.jpg" class="img-fluid rounded-5" loading="lazy">
                    </div>
                    <div class="col-md-4">
                        <img src="img/tim.maia5.jpg"
                            class="img-fluid rounded-5" loading="lazy">
                    </div>
                </div>
             </div>
